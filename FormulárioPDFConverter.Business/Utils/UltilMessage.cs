        ...
        public static string CreateMessageAuto(string mensagemCorpo)
        {
            ...
            switch (mensagemCorpo)
            {
                case "Ficha de Inscrição não assinada e/ou não encontrada.":
                    mensagemObservacaoAuto = "Documento não assinado e/ou não encontrado.\r\n Solicitamos o envio no prazo de 5 (cinco) dias a partir do recebimento deste comunicado. O não cumprimento poderá resultar no bloqueio do acesso ao sistema. \r\n";
                    break;
